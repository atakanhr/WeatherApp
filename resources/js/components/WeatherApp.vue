    ...
    <div class="text-white mb-8">
        ...
        <div class="weather-container font-sans w-128 max-w-lg rounded-lg overflow-hidden bg-gray-900 shadow-lg mt-4">
            <div class="current-weather flex items-center justify-between px-6 py-8">
                <div class="flex items-center">
                    <div>
                        ...
                        <div>{{"Hissedilen "+currentTemperature.feels+"°C"}}</div>
                    </div>
                    <div class="mx-5">
            ...
            <div class="future-weather text-sm bg-gray-800 px-6 py-8 overflow-hidden">
                <div
                    v-for="(day , index) in daily" :key="day.time"
                ...
                >
                    ...
                    <div class="w-4/6 px-4 flex items-center">
                        <div>
                            <canvas :id="`icon${index+1}`" :data-icon="toKebabCase(day.icon)" width="24"
                                    height="24"></canvas>
                        </div>
    ...
    export default {
        mounted() {
            var placesAutocomplete = places({
                appId: 'plJY96E8IG40',
                apiKey: '3d94cb5355f6f5894e9a432f5f4b973d',
        ...
        methods: {
            ...
            toDayOfWeek(timestamp) {
                ...
                const days = ['PAZ', 'PZT', 'SAL', 'ÇRŞ', 'PER', 'CUM', 'CTS']
